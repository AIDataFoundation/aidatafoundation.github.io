                ...
                <div className="sticky top-24 space-y-6">
                  ...
                  <div className="bg-card border border-border rounded-xl p-6">
                    ...
                    <div className="space-y-2 text-sm">
                      <a href="#overview" className="block text-muted-foreground hover:text-foreground transition-colors">Overview</a>
                      <a href="#features" className="block text-muted-foreground hover:text-foreground transition-colors">Features</a>
                      <a href="#conclusion" className="block text-muted-foreground hover:text-foreground transition-colors">Conclusion</a>
                    </div>
                  </div>
                  ...
                  <div className="bg-card border border-border rounded-xl p-6">
                    ...
                    <div className="flex flex-col gap-3">
                      <button className="flex items-center gap-3 p-3 text-muted-foreground hover:text-primary hover:bg-accent rounded-lg transition-all duration-200">
