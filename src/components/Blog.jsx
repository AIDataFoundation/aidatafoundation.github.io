...
- Ensure there are no duplicates
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 py-12">
      ...
      <p className="text-grayFill text-lg mb-12 max-w-3xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 gap-12">
        {blogPosts.map(post => (
          <div key={post.id} className="bg-bgGray p-8 rounded-xl shadow-md">
            <div className="mb-4">
            ...
            <div className="mt-8 pt-6 border-t border-gray-700">
              <div className="flex items-center justify-between">
                ...
                <a href={`#blog/${post.id}`} className="text-blue-500 hover:underline">Continue Reading →</a>
              </div>
            </div>
          </div>
        ))}
